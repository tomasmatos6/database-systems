...
<div class="table-container">
	...
	<table border="1">
        ...
        <%
        	idClubeHorario = jc.getIdClubeHorario(Integer.parseInt(resultSet.getString("id")), nifClube, resultSet.getString("Dia_da_Semana"));
            }
            resultSet.close();
        %>
    </table>  
    ...
    function saveRow(button) {
        ...
        var id = button.getAttribute('data-id');
        var idClubeHorario = <%= idClubeHorario %>
        
       	callProcessHorariosServlet(newDiaSemana, newAbertura, newFecho, id, idClubeHorario);
    }
    
    function callProcessHorariosServlet(diaSemana, abertura, fecho, id, idClubeHorario) {
        $.ajax({
            type: 'POST',
            url: 'horarios', 
            data: {
