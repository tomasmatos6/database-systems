...
<div class="table-container">
    <table class="clientes" border="1">
        ...
        %>
                    <tr>
                        <td class="clickable-cell" onclick="openNewWindow('<%= nomeEquipamento %>')" data-id="<%= nomeEquipamento %>">
                            <%= nomeEquipamento %>
                        </td>
                        <td>
...
function openNewWindow(equipamentoNome) {
	
	var nifClube = '<%= nifClube %>';
	var idEquipamento = '<%= idEquipamento_usos %>';
