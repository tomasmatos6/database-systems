...
<h2>Tipo de atividade: <%= resultSet.getString("TipoDeAtividade")%> | Inscrições: <%= resultSet.getString("Inscricoes")%> | Vagas: <%= (Integer.parseInt(resultSet.getString("Vagas")) - Integer.parseInt(resultSet.getString("Inscricoes")))%></h2>
